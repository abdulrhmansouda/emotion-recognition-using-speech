...
class AudioExtractor:
    ...
    def __init__(self, audio_config=None, verbose=1, features_folder_name="features", classification=True,
        ...
        self.audio_config = audio_config if audio_config else {
            'mfcc': True, 'chroma': True, 'mel': True, 'contrast': False, 'tonnetz': False}
    ...
    def load_metadata_from_desc_file(self, desc_files, partition):
        ...
        if not self.classification:
            ...
            if len(self.emotions) == 3:
                ...
                self.categories = {'angry': 1, 'sad': 2,
                                   'neutral': 3, 'ps': 4, 'happy': 5}
            else:
                raise TypeError(
        ...
        name = os.path.join(self.features_folder_name,
